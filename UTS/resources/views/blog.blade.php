...
@section('content')
                ...
                @foreach ($posts as $post)
                    <article class="bg-white rounded-lg shadow-lg overflow-hidden">
                        <div class="p-6">
                            ...
                            {{-- Link Read more dengan slug --}}
                            <a href="{{ route('blog.show', $post->slug) }}" class="text-sm font-medium text-blue-500 hover:underline">Read more</a>
                        </div>
                    </article>
                @endforeach
            </div>
    ...
    <div class="mt-8 flex items-center justify-center space-x-2 p-4">
